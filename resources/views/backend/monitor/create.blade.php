...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
             <div>
                <h4 class="page-title pt-2">Create Monitor</h4>
             </div>
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header bg-white border-0 py-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="fw-bold mb-0">Monitor Details</h5>
                                <small class="text-muted">Enter target information to start tracking availability.</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4 pt-2">
                        <form action="{{ route('monitor.store') }}" method="POST">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. My Website" required>
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                                            <option value="website" {{ old('type') == 'website' ? 'selected' : '' }}>Website (HTTP/HTTPS)</option>
                                            <option value="server" {{ old('type') == 'server' ? 'selected' : '' }}>Server (Ping)</option>
                                ...
                                <div class="col-md-6" id="ip-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="ip_address" id="ip_address" class="form-control @error('ip_address') is-invalid @enderror" value="{{ old('ip_address') }}" placeholder="e.g. 192.168.1.1">
                                        @error('ip_address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="check_interval" id="check_interval" class="form-select @error('check_interval') is-invalid @enderror" required>
                                            <option value="60" {{ old('check_interval', '60') == '60' ? 'selected' : '' }}>Every 1 Minute</option>
                                            <option value="300" {{ old('check_interval') == '300' ? 'selected' : '' }}>Every 5 Minutes</option>
                                            <option value="600" {{ old('check_interval') == '600' ? 'selected' : '' }}>Every 10 Minutes</option>
                                            <option value="1800" {{ old('check_interval') == '1800' ? 'selected' : '' }}>Every 30 Minutes</option>
                                            <option value="3600" {{ old('check_interval') == '3600' ? 'selected' : '' }}>Every 1 Hour</option>
                                        </select>
                                ...
                                <div class="col-md-6 d-flex align-items-center mt-md-4">
                                    <div class="form-check form-switch fs-5">
                                        ...
                                        <label class="form-check-label small fw-semibold text-secondary fs-6 ms-2" for="is_active">Start Monitoring Immediately</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary px-4">Create Monitor</button>
                            </div>
                        </form>
                    </div>
                </div>
